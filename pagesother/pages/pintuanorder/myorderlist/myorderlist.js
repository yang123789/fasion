...
Page({
  ...
  onShow: function () {
    ...
    app.sendRequest({
      url: 'api.php?s=Pintuan/myOrderList',
      data: {
        status: status
      },
        ...
        if (code == 0) {
          ...
          for (let index in order_list) {
            ...
            for (let key in order_list[index].order_item_list) {
              if (order_list[index].order_item_list[key].picture != undefined) {
                ...
                order_list[index].order_item_list[key].picture = {};
                order_list[index].order_item_list[key].picture.pic_cover_small = '';
              }
            }
          }
        ...
        if (code == 0) {
          ...
          for (let index in new_order_list) {
            ...
            for (let key in new_order_list[index].order_item_list) {
              if (new_order_list[index].order_item_list[key].picture != undefined) {
                ...
                new_order_list[index].order_item_list[key].picture = {};
                new_order_list[index].order_item_list[key].picture.pic_cover_small = '';
              }
            }
            //优化数据传入
